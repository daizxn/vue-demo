...
onMounted(() => {
  ...
  // 检查参数
  console.log("LinkCard mounted with URL:", props.url);
  console.log("LinkCard mounted with title:", props.title);
  console.log("LinkCard mounted with description:", props.description);
  console.log("LinkCard mounted with image:", props.image);
})
